    ...
    <div class="relative h-[250px] w-full overflow-x-auto">
      ...
      >
        ...
        <g class="y-axis-labels">
          <text x="5" y="15" class="fill-gray-500 text-xs dark:fill-gray-400">{{ maxCount }}</text>
          <text x="5" y="65" class="fill-gray-500 text-xs dark:fill-gray-400">
            {{ Math.round(maxCount * 0.75) }}
          </text>
          <text x="5" y="115" class="fill-gray-500 text-xs dark:fill-gray-400">
            {{ Math.round(maxCount * 0.5) }}
          </text>
          <text x="5" y="165" class="fill-gray-500 text-xs dark:fill-gray-400">
        ...
        <g class="chart-bars">
          ...
          >
            ...
            <text
              ...
              :y="brand.y - 5"
              text-anchor="middle"
              class="fill-gray-700 text-xs font-semibold dark:fill-gray-300"
            >
              {{ brand.count }}
            </text>
            ...
            <text
              ...
              y="215"
              text-anchor="middle"
              class="fill-gray-600 text-xs transition-colors duration-200 dark:fill-gray-400"
              :class="{
