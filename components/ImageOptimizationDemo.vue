        ...
        <UCard>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="text-center">
                    ...
                    <NuxtImg :src=" sampleImages[ 0 ]?.url || '' " alt="Mobile phone example"
                        class="w-full h-32 object-cover rounded-lg shadow-sm" :loading=" 'lazy' " />
                ...
                <div class="text-center">
                    ...
                    <NuxtImg :src=" sampleImages[ 0 ]?.url || '' " alt="Mobile phone example"
                        class="w-full h-32 object-cover rounded-lg shadow-sm" format="webp" quality="80"
                        :loading=" 'lazy' " />
                ...
                <div class="text-center">
                    ...
                    <NuxtImg :src=" sampleImages[ 0 ]?.url || '' " alt="Mobile phone example"
                        class="w-full h-32 object-cover rounded-lg shadow-sm" sizes="320px sm:640px lg:1024px"
                        :loading=" 'lazy' " />
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                            @nuxt/image automatically serves the best format (WebP, AVIF) based on browser support.
                            Images are compressed and sized appropriately for each device.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <UCard>
            <template #header>
                <div class="flex justify-between items-center">
                    ...
                    <UBadge :color=" imageQuality === 'high' ? 'green' : imageQuality === 'medium' ? 'yellow' : 'red' "
                        variant="soft">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div v-for=" ( image, index ) in paginatedImages " :key=" index " class="group cursor-pointer"
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-sm group-hover:shadow-md transition-shadow">
                        <NuxtImg :src=" image.url " :alt=" image.alt "
                            ...
                            :quality=" imageQualityValue " format="webp" :loading=" 'lazy' "
        ...
        <UModal v-model=" isModalOpen ">
            <div class="p-4">
                <div v-if=" selectedImage " class="text-center">
                    <NuxtImg :src=" selectedImage.url " :alt=" selectedImage.alt "
                        class="max-w-full h-auto max-h-96 object-contain rounded-lg shadow-lg" format="webp"
                        quality="95" />
...
<script setup lang="ts">
    ...
    {
        return qualityPresets.find( p => p.value === imageQualityValue.value )?.label.toLowerCase() || 'medium'
    } )
