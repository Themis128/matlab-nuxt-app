...
class LintingAutomationSummary {
  ...
  generateConfigurationReport() {
    ...
    const configs = [
      {
        ...
        status: fs.existsSync('.vscode/settings.json') ? '✅' : '❌',
      },
      ...
      {
        file: 'scripts/auto-fix-all.cjs',
        status: fs.existsSync('scripts/auto-fix-all.cjs') ? '✅' : '❌',
      },
      {
        file: 'scripts/file-watcher-auto-fix.cjs',
        status: fs.existsSync('scripts/file-watcher-auto-fix.cjs') ? '✅' : '❌',
      },
      {
        file: 'scripts/batch-auto-fix.cjs',
        status: fs.existsSync('scripts/batch-auto-fix.cjs') ? '✅' : '❌',
      },
      {
        file: 'scripts/integration-test-linting.cjs',
        status: fs.existsSync('scripts/integration-test-linting.cjs') ? '✅' : '❌',
      },
    ];
    ...
    this.log(
      `  ${hasLintStaged ? '✅' : '❌'} lint-staged configuration`,
      hasLintStaged ? 'green' : 'red'
    );
    this.log(
      `  ${hasGitHooks ? '✅' : '❌'} Git hooks configuration`,
      hasGitHooks ? 'green' : 'red'
    );
    this.log('', 'reset');
  }
