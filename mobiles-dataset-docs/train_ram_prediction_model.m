% RAM Prediction Model Training
% This script trains a model to predict RAM capacity from other phone specifications
% Input: Battery, Screen Size, Weight, Year, Price, Company
% Output: RAM in GB
%
% Usage: run('train_ram_prediction_model.m')

fprintf('=== RAM Prediction Model Training ===\n\n');
...
% Features: Battery, Screen Size, Weight, Year, Price, Company
% Target: RAM
...
%% Step 6: Train
fprintf('\nStep 6: Training RAM prediction model...\n\n');
...
resultsPath = 'trained_models/ram_prediction_results.mat';
save(resultsPath, 'YPred', 'YTest_original', 'testIdx', ...
     'mse', 'mae', 'rmse', 'r2', 'mape');
fprintf('   ✓ Results saved to: %s\n', resultsPath);

fprintf('\n=== RAM Prediction Model Training Complete ===\n\n');
