                        ...
                        <div class="p-6">
                            <div class="space-y-2">
                                ...
                                <p><strong>Documentation:</strong>
                                    <a :href=" `${ pythonBaseUrl }/docs` " target="_blank"
                                        class="text-blue-600 hover:underline">Swagger UI</a>
                                    |
                                    <a :href=" `${ pythonBaseUrl }/redoc` " target="_blank"
                                        class="text-blue-600 hover:underline">ReDoc</a>
                                </p>
                            </div>
                        </div>
                    </UCard>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">Check API health status</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Get mobile phone models
                                            within a price
                                            range</p>
                                        ...
                                        <div class="text-xs text-gray-500 mt-1">
                                            <strong>Example:</strong> {{ pythonBaseUrl
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Get basic statistics
                                            about the dataset
                                        </p>
                                        <div class="text-xs text-gray-500">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Get list of all
                                            companies/brands in the
                                            dataset</p>
                                        <div class="text-xs text-gray-500">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Advanced search with
                                            multiple filters
                                        </p>
                                        <div class="text-xs text-gray-500">
                                            <strong>Parameters:</strong> brand[], minPrice, maxPrice, minRam, maxRam,
                                            minBattery,
                                            maxBattery, minScreen, maxScreen, year[], minStorage, maxStorage, processor,
                                            sortBy,
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Compare multiple models
                                            side by side
                                        </p>
                                        <div class="text-xs text-gray-500">
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Predict mobile phone
                                            price based on
                                            specifications</p>
                                        <div class="text-xs text-gray-500">
                                            <strong>Body:</strong> {ram, battery, screen, weight, year, company,
                                            front_camera?,
                                            back_camera?, processor?, storage?}
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Predict RAM capacity
                                            based on
                                            specifications</p>
                                        <div class="text-xs text-gray-500">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Predict battery
                                            capacity based on
                                            specifications</p>
                                        <div class="text-xs text-gray-500">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Predict brand based on
                                            specifications
                                        </p>
                                        <div class="text-xs text-gray-500">
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Get price information
                                            for a specific
                                            country</p>
                                        <div class="text-xs text-gray-500">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Find the closest matching model
                                    based on
                                    specifications</p>
                                <div class="text-xs text-gray-500">
...
<script setup lang="ts">
    ...
    useHead( {
        ...
        meta: [
            { name: 'description', content: 'Complete API documentation for all endpoints in the Mobile Finder application' }
        ]
    } )
</script>
