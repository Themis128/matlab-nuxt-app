        ...
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-6xl mx-auto">
                ...
                <div v-if=" model && !loading ">
                    <!-- Header -->
                    <div class="mb-8">
                        <UButton @click="navigateTo( '/search' )" color="gray" variant="ghost"
                            icon="i-heroicons-arrow-left" class="mb-4">
                            Back to Search
                        </UButton>
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex gap-4 mb-6">
                                    ...
                                    <UButton @click=" findSimilar " color="green" variant="outline"
                                        icon="i-heroicons-sparkles">
                                        Find Similar
                                    </UButton>
                                    <UButton @click=" searchByPrice " color="purple" variant="outline"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <UCard>
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div v-if=" !model.storage && !model.processor && !model.frontCamera && !model.backCamera "
                    ...
                    <UCard v-if=" similarModels.length > 0 " class="mb-8">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <UCard v-for=" similar in similarModels " :key=" similar.model.modelName "
                                        ...
                                        <div class="flex justify-between items-start mb-2">
                                            <div>
                                                <h3 class="font-bold text-gray-900 dark:text-white">{{
                                                    similar.model.modelName }}</h3>
                                                <p class="text-sm text-gray-600 dark:text-gray-400">{{
                                                    similar.model.company }}</p>
                                            </div>
                                            <UBadge :color=" similar.similarityScore > 80 ? 'green' : 'yellow' "
                                                variant="soft">
...
<script setup lang="ts">
    ...
    const modelName = decodeURIComponent( route.params.slug as string )
