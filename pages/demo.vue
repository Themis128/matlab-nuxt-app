  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
    <div class="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div class="text-center mb-8">
        <div class="inline-flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm mb-4">
      ...
      <UCard class="mb-8">
        <template #header>
          <h2 class="text-2xl font-semibold">🧠 AI Buyer Advisor</h2>
      ...
      <UCard class="mb-8">
        <template #header>
          <h2 class="text-2xl font-semibold">🎯 Smart Phone Advisor</h2>
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
        ...
        <form class="space-y-8" data-testid="demo-form" @submit.prevent=" runSmartRecommendations ">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Budget Input -->
            <div class="space-y-4">
              <h3 class="text-xl font-semibold text-gray-900 dark:text-white">💰 Your Budget</h3>
              <div class="space-y-3">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                  Maximum budget ($)
                </label>
                <input data-testid="budget-input" v-model=" smartForm.budget " type="number" placeholder="500" min="100"
                  max="2000"
            ...
            <!-- Use Case Input -->
            <div class="space-y-4">
              <h3 class="text-xl font-semibold text-gray-900 dark:text-white">🎮 Primary Use</h3>
              <div class="space-y-3">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                  What will you use it for most?
                </label>
                <select v-model=" smartForm.useCase "
                  class="w-full text-lg px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-colors">
                  ...
                  <option value="battery">🔋 Long Battery Life</option>
          ...
          <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select v-model=" smartForm.phoneAge "
              ...
              <div>
                ...
                <select v-model=" smartForm.preferredBrand "
                  class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800">
              ...
              <div>
                ...
                <select v-model=" smartForm.dealPriority "
                  class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800">
          ...
          <div class="flex flex-wrap gap-4 pt-4">
            <button data-testid="smart-button" type="submit" :disabled=" !smartFormValid || isRunning "
              :aria-busy=" isRunning "
              ...
              <span v-if=" !isRunning ">🚀 Get AI Recommendations</span>
              <span v-else>🧠 Analyzing...</span>
            </button>
            <button type="button" @click=" clearSmartForm "
          ...
          <!-- Prediction Results -->
          <div v-if=" resultsVisible " class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 prediction-result">
      ...
      <div class="flex flex-wrap gap-4 justify-center mb-12">
        <NuxtLink to="/search" class="px-3 py-2 rounded-md bg-gray-100 dark:bg-gray-800 text-sm">Advanced Search
        </NuxtLink>
        <NuxtLink to="/compare" class="px-3 py-2 rounded-md bg-gray-100 dark:bg-gray-800 text-sm">Compare Models
        </NuxtLink>
        <NuxtLink to="/recommendations" class="px-3 py-2 rounded-md bg-gray-100 dark:bg-gray-800 text-sm">
          Recommendations
        </NuxtLink>
