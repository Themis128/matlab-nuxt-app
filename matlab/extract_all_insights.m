...
priceCol = data.('Launched_Price_USA');
for i = 1:height(data)
...
% Extract year
year = data.('Launched_Year');

% Extract company names
companyCol = data.('Company_Name');
...
regionColumns = {'Launched_Price_Pakistan', 'Launched_Price_India', ...
