...
class DataPipeline:
    ...
    def load_dataset_with_images(self, csv_path: str, image_base_dir: str = "../public/mobile_images",
                               create_relationships: bool = True) -> Dict[str, Any]:
        """
    ...
    def load_bulk_datasets(self, data_dir: str, pattern: str = "*.csv",
                          image_dir: str = "../public/mobile_images") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for csv_file in csv_files:
                try:
                    ...
                    file_results = self.load_dataset_with_images(
                        csv_path=csv_file,
    ...
    def _generate_summary(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        total_images = sum(len(file_result['results'].get('images_loaded', []))
        ...
        return {
            ...
            'processing_time': str(self.stats['end_time'] - self.stats['start_time']) if self.stats['end_time'] else None,
            'success_rate': f"{(len(results['processed_files']) / results['total_files'] * 100):.1f}%" if results['total_files'] > 0 else "0%"
        }
